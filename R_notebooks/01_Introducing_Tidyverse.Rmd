...
When you install the `tidyverse` package, you install a suite of 9 packages (at
the time of writing). These are as follows; we've marked the ones this course
...
**Note**: We'll also be using a couple of other very popular packages that are
part of the 'non-core' Tidyverse:

-   `lubridate`: Working with dates.
-   `magrittr`: Operators to make for more readable data manipulation (such as
    the 'pipe' operator `%>%`).
...
Data](https://doi.org/10.18637/jss.v059.i10) paper[^1].
